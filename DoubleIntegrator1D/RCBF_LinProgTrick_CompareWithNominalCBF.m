...
%% Plot Cost
figure;hold on;grid on;box on;
p3 = plot(CBFLOGS1.Time,CBFLOGS1.cost,'LineWidth',2);
p4 = plot(CBFLOGS2.Time,CBFLOGS2.cost,'LineWidth',2);
p5 = plot(RCBFLOGS1.Time,RCBFLOGS1.cost,'LineWidth',2);
p6 = plot(RCBFLOGS2.Time,RCBFLOGS2.cost,'LineWidth',2);
ylabel('cost(t)','FontSize',12);
xlabel('t (sec)','FontSize',12);
legend('Nominal Plant - Nominal CBF',...
    'Uncertain Plant - Nominal CBF',...
    'Nominal Plant - Robust CBF',....
