...
odeParams = struct('A',A,'B',B,'K',K,'cT',cT,'rT',rT,'P',P,'alpha',2,'beta',2);
...
% Plot Levelset of P
Vlevel = [10;0]'*P*[10;0];
p6 = plot_gaussian_ellipsoid([0;0],inv(P)*Vlevel);
p6 = patch(p6.XData,p6.YData,'c','LineWidth',2);
p6.EdgeColor = 'c';
...
xlim([-20 20]);
ylim([-15 15]);
legend([p1 p2 p3 p4 p5 p6],'Openloop','LQR Baseline','Unsafe Region','CBF QP \alpha = 2','CLF-CBF QP \alpha = \gamma = 2','LevelSet V(x) = 135.32','FontSize',12,'Location','northwest');