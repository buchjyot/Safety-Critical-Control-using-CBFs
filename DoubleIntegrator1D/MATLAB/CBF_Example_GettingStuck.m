...
odeParams = struct('A',A,'B',B,'K',K,'cT',cT,'rT',rT,'P',P,'alpha',2);
...
xlim([-20 20]);
ylim([-15 15]);
legend([p1 p2 p3 p4],'Openloop','LQR Baseline','Unsafe Region','CBF-QP \alpha = 2','FontSize',12,'Location','northwest');